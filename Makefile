...
#链接启动文件和链接脚本
LFLAGS			+= $(TOP)/CORE/startup_stm32f10x_md.s
...
#自定义源文件添加
C_SRC			+= $(HARD_DIR)/usart.c $(HARD_DIR)/spi.c $(HARD_DIR)/delay.c $(HARD_DIR)/led.c $(HARD_DIR)/adc.c
C_SRC			+= $(APP)/nrf24l01.c $(APP)/key.c 
